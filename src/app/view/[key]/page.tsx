...
import { getMediaType, formatFileSize } from "@/lib/types";
      ...
      >
        ...
        {mediaType === "audio" && (
          ...
          >
            ...
            <audio src={publicUrl} controls style={{ width: "100%", maxWidth: "500px" }}>
        ...
        >
          {metadata.contentType} &middot; {formatFileSize(metadata.size)}
        </div>
